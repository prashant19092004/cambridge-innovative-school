    ...
    <div className='px-[25px] lg:px[50px] py-10 bg-[#f2f7fd]'>
        <div className='flex justify-between items-start flex-wrap'>
            <div className='w-[100%] md:w-[30%] sm:w-[50%] mt-10'>
                <img className='w-[150px] mb-7' src={logo} alt='' />
            ...
            <div className='w-[100%] md:w-[30%] sm:w-[50%] mt-10'>
                ...
                <ul className='list-none flex flex-col gap-1'>
                    ...
                    <li><a href='#' className='text-zinc-700 footer-links'>About</a></li>
                    <li><a href='#' className='text-zinc-700 footer-links'>Facilities</a></li>
                    <li><a href='#' className='text-zinc-700 footer-links'> Contact Us</a></li>
                    {/* <li><a href='#' className='text-zinc-700 footer-links'>Home</a></li> */}
                </ul>
            </div>
        </div>
        ...
        <div>
            <p className='text-zinc-700'>© Copyrights 2020 Well adept infotech All rights reserved</p>
        </div>
    </div>
  )
}
