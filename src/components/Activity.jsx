...
import activity_pic from '../assets/activity_pic.png';
import './Activity.css';
import './style.css';
  ...
  return (
    <div className='px-[20px] md:px-[30px] lg:px-[75px] py-20'>
        ...
        <div className='flex flex-wrap w-full gap-6 sm:gap-12 justify-between relative'>
            <div className='bg-white rounded-full overflow-hidden absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[35%] outline-dashed outline-2 outline-[#0fbaf4] p-3'>
