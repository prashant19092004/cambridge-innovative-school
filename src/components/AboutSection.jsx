    ...
    <div className='w-[100%] px-[20px] lg:px-[75px] pt-20'>
        <div className='flex justify-between w-full'>
            ...
            <div className='w-[90%] md:w-[45%]'>
                ...
                <button className='bg-[#ff9900] mt-7 hover:bg-[#f59c17] px-5 py-5 text-sm font-medium text-white rounded-2xl flex gap-3 items-center'>Explore More<span><FaArrowRightLong color='white' /></span></button>
            </div>
        </div>
    </div>
  )
